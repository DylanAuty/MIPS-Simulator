...
{	
	...
	Driver_LoadInstructions(argc>1 ? argv[1] : "t5_input-mips.bin", (uint32_t*)pMem);
	...
	for(i=0;i<10;i++){
		...
		mips_set_register(state, R_a1, b);	// Passing a pointer to the function
